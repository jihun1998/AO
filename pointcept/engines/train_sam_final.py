...
class Trainer(TrainerBase):
    ...
    def after_epoch(self):
        ...
        if comm.is_main_process():
            ...
            embedding_root = '/mnt/jihun4/pointceptHJ/data/embeddings_mobile'
                        ...
                        for cidx in cls_gt_now:
                            ...
                            if cls_mask_grid.sum()>0:
                                ...
                                if incognita.sum()>0:
                                    ...
                                    # TODO-for-JHK
                                    if confidence_now[max_conf_idx]>0.9:
    ...
    def build_model(self):
        ...
        temp = torch.load("/mnt/jihun4/pointceptHJ/exp/s3dis/mobile_sam_pp2s/model/model_best.pth")['state_dict'] # ours sam best
        sd = {}
    ...
    def build_train_loader(self):
        ...
        if comm.is_main_process():
            ...
            os.system("cp -r /mnt/jihun4/pointceptHJ/data/sam_labels_mobile " + self.cfg.data.train.weak_path)
