...
class Trainer(TrainerBase):
    def __init__(self, cfg):
        ...
        self.log_dir = './'+self.cfg.save_path
    ...
    def after_epoch(self):
        ...
        if comm.is_main_process():
            ...
            cls_gt_root = './data/s3dis_cls_gt'
            rgb_2d_root = './data/S2D3D'
            bridge_root = './data/bridge'
            # bridge_root2 = './data/bridge2'
            
            embedding_root = './data/embeddings'
            # embedding_root2 = './data/embeddings2'
    ...
    def build_model(self):
        ...
        # temp = torch.load("./exp/s3dis/semseg-pt-v2m2-0-sam-level-0/model/model_best.pth")['state_dict'] # ours sam best
        temp = torch.load("./exp/s3dis/mobile_sam_pp2s/model/model_best.pth")['state_dict'] # ours sam best
        sd = {}
    ...
    def build_train_loader(self):
        ...
        self.cfg.data.train.mode = 'real'
        self.cfg.data.train.weak_path = './'+self.cfg.save_path+'/sam_labels_on_the_fly'
        if comm.is_main_process():
            # os.system("cp -r /home/vilab/khj/ssd0/pointcept/data/sam_labels_0.02 " + self.cfg.data.train.weak_path)
            os.system("cp -r ./data/sam_labels " + self.cfg.data.train.weak_path)
