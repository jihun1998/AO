...
class Trainer(TrainerBase):
    ...
    def after_epoch(self):
        ...
        if comm.is_main_process():
            pickle_paths = glob.glob(pickle_root+'/*prompt.pickle')
                    ...
                    for yidx in range(int(math.ceil(length_y//grid_scale))):
                        ...
                        for cidx in cls_gt_now:
                            ...
                            if cls_mask_grid.sum()>0:
                                confidence_now = confidence_grid[cls_mask_grid]
                                ...
                                if confidence_now[max_conf_idx]>0.95: 
                                    ...
                                    prompt_idx.append(temp_idx[mask_grid][cls_mask_grid][max_conf_idx])
    ...
    def build_model(self):
        ...
        #
        # temp = torch.load("/mnt/jihun4/pointceptHJ/exp/s3dis/sam_0.02_lv0/model/model_best.pth")['state_dict'] # 0.02 sam best
        temp = torch.load("/mnt/jihun4/pointceptHJ/exp/s3dis/render_sam/model/model_best.pth")['state_dict'] # ours sam best
        sd = {}
    ...
    def build_train_loader(self):
        ...
        if comm.is_main_process():
            # os.system("cp -r /mnt/jihun4/pointceptHJ/data/sam_labels_0.02 " + self.cfg.data.train.weak_path)
            os.system("cp -r /mnt/jihun4/pointceptHJ/data/rendered_sam_labels " + self.cfg.data.train.weak_path)
