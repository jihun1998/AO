...
# sampled_cameras_root = '../../datadata/sampled_cameras'
bridge_root = '../../data/bridge_test'
...
for area_3d_path in area_3d_paths:
    ...
    for room_path in room_paths:
        ...
        print(room_path)
        # room_path = '../../data/s3dis/Area_1/conferenceRoom_1.pth'
        ...
        # rgb_paths = [os.path.join('../../data/S2D3D',area_str,'data','rgb',frame.split('/')[-1].replace('.pth','.png')) for frame in glob.glob(os.path.join('../../data/embeddings2',area_str,room_str,'*.pth'))]
        # import pdb;pdb.set_trace()
